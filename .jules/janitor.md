...
- 2026-07-02: Explicitly handle errors from `defer` closures and use `ReportError` instead of `slog.Error` directly to prevent silent failures and ensure centralized reporting.
